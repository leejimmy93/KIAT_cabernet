...
LG.f2.after.crossover$pheno <- LG.f2.after.crossover$pheno[,11237:16854]
...
names(scanone.imp.3) <- colnames(LG.f2.after.crossover$pheno) 

save(scanone.imp.3, file = "/share/malooflab/Ruijuan/F2/eQTL/no_scale_center/output/scanone_all_expressed_genes.imp.3.Rdata")

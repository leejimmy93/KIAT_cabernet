...
LG.f2.after.crossover$pheno <- LG.f2.after.crossover$pheno[,28091:33708]
...
names(scanone.imp.6) <- colnames(LG.f2.after.crossover$pheno) 

save(scanone.imp.6, file = "/share/malooflab/Ruijuan/F2/eQTL/no_scale_center/output/scanone_all_expressed_genes.imp.6.Rdata")

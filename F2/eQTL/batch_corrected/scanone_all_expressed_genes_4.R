...
LG.f2.after.crossover$pheno <- LG.f2.after.crossover$pheno[,16855:22472]
...
names(scanone.imp.4) <- colnames(LG.f2.after.crossover$pheno) 

save(scanone.imp.4, file = "/share/malooflab/Ruijuan/F2/eQTL/no_scale_center/output/scanone_all_expressed_genes.imp.4.Rdata")

...
LG.f2.after.crossover$pheno <- LG.f2.after.crossover$pheno[,50563:56180]
...
names(scanone.imp.10) <- colnames(LG.f2.after.crossover$pheno) 

save(scanone.imp.10, file = "/share/malooflab/Ruijuan/F2/eQTL/no_scale_center/output/scanone_all_expressed_genes.imp.10.Rdata")

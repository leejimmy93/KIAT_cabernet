...
system.time(
scantwo.perm.imp.20.2 <- 
  scantwo(LG.f2.after.crossover,pheno.col=41:43,method="hk",n.perm=10,n.cluster = 16)
)
names(scantwo.perm.imp.20.2) <- colnames(LG.f2.after.crossover$pheno)

sfStop()

# save output 
save(scantwo.perm.imp.20.2, file = "/share/malooflab/Ruijuan/F2/QTL_analysis/output/scantwo/scantwo.perm.imp.20.2.Rdata")

...
system.time(
scantwo.perm.imp.4.1 <- 
  scantwo(LG.f2.after.crossover,pheno.col=c(7,9),method="hk",n.perm=10,n.cluster = 16)
)
names(scantwo.perm.imp.4.1) <- colnames(LG.f2.after.crossover$pheno)

sfStop()

# save output 
save(scantwo.perm.imp.4.1, file = "/share/malooflab/Ruijuan/F2/QTL_analysis/output/scantwo/scantwo.perm.imp.4.1.Rdata")

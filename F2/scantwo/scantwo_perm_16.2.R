...
system.time(
scantwo.perm.imp.16.2 <- 
  scantwo(LG.f2.after.crossover,pheno.col=33:34,method="hk",n.perm=10,n.cluster = 16)
)
names(scantwo.perm.imp.16.2) <- colnames(LG.f2.after.crossover$pheno)

sfStop()

# save output 
save(scantwo.perm.imp.16.2, file = "/share/malooflab/Ruijuan/F2/QTL_analysis/output/scantwo/scantwo.perm.imp.16.2.Rdata")

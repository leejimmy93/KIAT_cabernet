...
system.time(
scantwo.perm.imp.3.8 <- 
  scantwo(LG.f2.after.crossover,pheno.col=5:6,method="hk",n.perm=10,n.cluster = 16)
)
names(scantwo.perm.imp.3.8) <- colnames(LG.f2.after.crossover$pheno)

sfStop()

# save output 
save(scantwo.perm.imp.3.8, file = "/share/malooflab/Ruijuan/F2/QTL_analysis/output/scantwo/scantwo.perm.imp.3.8.Rdata")

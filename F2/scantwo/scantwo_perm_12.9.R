...
system.time(
scantwo.perm.imp.12.9 <- 
  scantwo(LG.f2.after.crossover,pheno.col=25:26,method="hk",n.perm=10,n.cluster = 16)
)
names(scantwo.perm.imp.12.9) <- colnames(LG.f2.after.crossover$pheno)

sfStop()

# save output 
save(scantwo.perm.imp.12.9, file = "/share/malooflab/Ruijuan/F2/QTL_analysis/output/scantwo/scantwo.perm.imp.12.9.Rdata")

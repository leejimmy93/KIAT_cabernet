...
system.time(
scantwo.perm.imp.5.5 <- 
  scantwo(LG.f2.after.crossover,pheno.col=10:11,method="hk",n.perm=10,n.cluster = 16)
)
names(scantwo.perm.imp.5.5) <- colnames(LG.f2.after.crossover$pheno)

sfStop()

# save output 
save(scantwo.perm.imp.5.5, file = "/share/malooflab/Ruijuan/F2/QTL_analysis/output/scantwo/scantwo.perm.imp.5.5.Rdata")

...
system.time(
scantwo.perm.imp.8.2 <- 
  scantwo(LG.f2.after.crossover,pheno.col=17:18,method="hk",n.perm=10,n.cluster = 16)
)
names(scantwo.perm.imp.8.2) <- colnames(LG.f2.after.crossover$pheno)

sfStop()

# save output 
save(scantwo.perm.imp.8.2, file = "/share/malooflab/Ruijuan/F2/QTL_analysis/output/scantwo/scantwo.perm.imp.8.2.Rdata")

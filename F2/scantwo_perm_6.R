...
names(scantwo.perm.imp.6) <- colnames(LG.f2.after.crossover$pheno)

sfStop()

# save output 
save(scantwo.perm.imp.6, file = "/share/malooflab/Ruijuan/F2/QTL_analysis/output/scantwo.perm.imp.6.Rdata")
